          ...
          <div className="column is-three-quarter">
            ...
            <div className="columns">
              <div className="column is-one-third">
                ...
                >
                  <span className="tag is-warning has-text-weight-bold m-1">Javascript</span>
                  <span className="tag is-warning has-text-weight-bold m-1">React</span>
                  <span className="tag is-warning has-text-weight-bold m-1">Next.js</span>
                  <span className="tag is-warning has-text-weight-bold m-1">Bulma 4</span>
                </Project>
              </div>
              <div className="column is-one-third">
                <Project
                ...
                >
                  <span className="tag is-warning has-text-weight-bold m-1">PHP</span>
                  <span className="tag is-warning has-text-weight-bold m-1">Laravel</span>
                  <span className="tag is-warning has-text-weight-bold m-1">MySQL</span>
                  <span className="tag is-warning has-text-weight-bold m-1">Bootstrap 4</span>
                </Project>
              </div>
            </div>
